...
`AWS` `Terraform` `Kubernetes` `ECS/Fargate` `EKS` `ArgoCD` `Istio` `Docker`
`Linux` `CI/CD` `Go` `TypeScript`
...
- [aws-vpc](https://github.com/freeitas/aws-vpc) - High-availability VPCs for container architectures

### Security

- [aws-security-baseline](https://github.com/freeitas/aws-security-baseline) - Account-wide detection and response baseline: multi-region CloudTrail with log validation, GuardDuty, Config, Security Hub, and a fail-closed Lambda that isolates compromised instances
